      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-2">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Join the community and start tracking your environmental impact</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-6 rounded-lg bg-accent/50 p-4 text-sm">
          ...
          <p className="text-muted-foreground text-xs">
            This is a demo. Your account will be stored locally in your browser. No actual authentication server is
            used.
          </p>
        </div>
      </div>
